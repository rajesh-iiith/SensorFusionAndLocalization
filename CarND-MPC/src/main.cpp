    ...
    // cout << sdata << endl;
      if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
        ...
        if (s != "") {
          ...
          /*
          * TODO: Calculate steeering angle and throttle using MPC. Both are in between [-1, 1].
          */

          double steer_value = j[1]["steering_angle"];
          double throttle_value = j[1]["throttle"];
          // negate because steering values from simulator are reverse
